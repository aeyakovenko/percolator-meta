...
`c8cf4de81951535bc0749bd4b284ad4c8e7d056c` and its engine layout dependency to
...
3. **Bootstrap vote.** The default bootstrap delay is six 30-day months and is configurable in the
   ...
   unwithdrawn principal. A proposal is not
