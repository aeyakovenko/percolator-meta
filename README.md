...
At the first freeze-eligible slot, crystallization is closed and only the immutable denominator
snapshot may proceed, so a late refresh cannot race freeze and redistribute another stake's share.
