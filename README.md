...
- **Lifecycle is separate from custody.** The immutable `market-controller` PDA holds
  ...
  same-key account generation in another market cannot replace or block the archived identity.
