...
5. **Return deposits.** The intended genesis flow keeps custody in the owner-bound pool while
   ...
   proposal won. That atomic return subtracts any exact live ballot from its proposal and global
   tallies; remaining capital decides, while a refunded vote cannot clear quorum. The instruction
